...
\item Demande variée: petits besoins (scripts), developpement d'applications en indépendance ou en tandem avec un dev Front et gestion des déploiements sur AWS avec Terraform
\end{tightemize}
\sectionsep
